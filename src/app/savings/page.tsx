  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="col-span-2 rounded-xl bg-gradient-to-br from-accent to-accent-dark p-6 flex flex-col justify-between hover:shadow-lg hover:-translate-y-0.5 transition-all">
          <span className="text-xs font-medium text-accent">Estimated annual opportunity</span>
          <div className="font-display text-5xl font-bold text-white mt-4">€{totalAnnualOpportunity.toLocaleString()}</div>
        </div>
